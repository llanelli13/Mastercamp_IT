            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody v-if="!loading" class="bg-white divide-y divide-gray-200 w-full">
                ...
                <tr v-for="l in loans" v-bind:key="l">
                  ...
                  <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap"><p class="w-28 overflow-hidden text-ellipsis">{{l.purpose}}</p></td>
                  <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
