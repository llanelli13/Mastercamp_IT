<template>
  <div className="w-full h-full bg-gray-100 flex items-center justify-center">
    <div className="w-4/5 bg-myBlue h-4/5 rounded-xl drop-shadow-2xl">
      <h1 className="text-xl font-extrabold sm:text-3xl h-1/6 pt-4 w-full text-center text-blue-950">Loan Application</h1>
      <div className="sm:flex h-4/6 justify-center items-center">
        <div className="w-4/5 h-1/2 sm:w-2/5 sm:h-4/5 mx-auto">
          <div className="h-1/3">
            <label  className="block text-sm text-black">Total amount of your loan</label>
            <input v-model="amount" type="number" placeholder="Ex : 20 000"
          ...
          <div className="h-1/3">
            ...
            <input v-model="duration" type="number" placeholder="Ex : 40"
                   className="block  w-full placeholder-gray-400/70 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"/>
          </div>
        </div>
        <div className="w-4/5 h-1/2 sm:w-2/5 sm:h-4/5 mx-auto">
          ...
          <div className="h-1/3">
            <label htmlFor="HeadlineAct" className="block text-sm text-black">Broker</label>
